...
type HealthRequest struct {
	...
	Type uint32 `protobuf:"varint,1,opt,name=type,proto3" json:"type,omitempty"` // 0-检查线程和文件 1-检查线程 2-检查文件
}
...
func (x *HealthReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *HealthReply) GetResult() bool {
	if x != nil {
		return x.Result
	}
	return false
...
var file_checker_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x4b,
	...
	0x01, 0x28, 0x08, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x9d, 0x02, 0x0a, 0x05,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x59, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x27,
	0x2e, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x63,
	0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x6c,
	0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00,
	...
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x5d, 0x0a, 0x09,
	0x47, 0x65, 0x74, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x27, 0x2e, 0x74, 0x72, 0x70, 0x63,
	0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x48, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x25, 0x2e, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65,
	0x72, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x1d, 0x5a, 0x1b, 0x67,
...
var file_checker_proto_depIdxs = []int32{
	0, // 0: trpc.checker.checkHealth.Check.Check:input_type -> trpc.checker.checkHealth.HealthRequest
	0, // 1: trpc.checker.checkHealth.Check.Health:input_type -> trpc.checker.checkHealth.HealthRequest
	0, // 2: trpc.checker.checkHealth.Check.GetHealth:input_type -> trpc.checker.checkHealth.HealthRequest
	1, // 3: trpc.checker.checkHealth.Check.Check:output_type -> trpc.checker.checkHealth.HealthReply
	1, // 4: trpc.checker.checkHealth.Check.Health:output_type -> trpc.checker.checkHealth.HealthReply
	1, // 5: trpc.checker.checkHealth.Check.GetHealth:output_type -> trpc.checker.checkHealth.HealthReply
