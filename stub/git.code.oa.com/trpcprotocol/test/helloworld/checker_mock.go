...
// Source: stub/git.code.oa.com/trpcprotocol/test/helloworld/checker.trpc.go
...
func (m *MockGreeterService) SayHello(ctx context.Context, req *HelloRequest, rsp *HelloReply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SayHello", ctx, req, rsp)
	ret0, _ := ret[0].(error)
	return ret0
}

// SayHello indicates an expected call of SayHello
func (mr *MockGreeterServiceMockRecorder) SayHello(ctx, req, rsp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHello", reflect.TypeOf((*MockGreeterService)(nil).SayHello), ctx, req, rsp)
}
